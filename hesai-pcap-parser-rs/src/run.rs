use std::{path::Path, fs::File, time::Instant, f32::consts::PI};

use pcap_parser::{LegacyPcapReader, traits::PcapReaderIterator, PcapBlockOwned, PcapError};
use writer_common::{framewriter::{FrameWriter, CsvWriter, HdfWriter, PcdWriter}, azimuthsplitwriter::AzimuthSplitWriter, velopoint::VeloPoint};
